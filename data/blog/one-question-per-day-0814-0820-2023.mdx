...
draft: false
summary: '1.617. 合并二叉树 2.833. 字符串中的查找与替换 3.2682. 找出转圈游戏输家 4.1444. 切披萨的方案数 5.1388. 3n 块披萨 6.2235. 两整数相加 7.2236. 判断根结点是否等于子结点之和'
layout: PostSimple
...
[1388. 3n 块披萨](https://leetcode.cn/problems/number-of-ways-of-cutting-a-pizza/description/)
